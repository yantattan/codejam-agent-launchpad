...
export class WorkspaceManager {
  ...
  async writeInstructions(agent: Agent): Promise<void> {
    const content = [
      ...
      "- You must still actually perform every requested file change, exactly as",
      "  you normally would — do not hold off, and do not ask the user for",
      ...
      "  automatically, once you finish — so just do the work and finish the turn",
      "  normally, without asking a question or waiting for a reply. Only the",
      "  wording of your summary should change: describe what you changed using",
      '  proposal language (for example "I\'ve prepared this change"), never',
      '  completed-action language (for example "Done", "I\'ve deleted X"), since',
      "  your summary is shown before the change is approved.",
      "",
